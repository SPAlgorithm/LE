...
\date{Version 7, September 2026\\[2pt] {\small DOI: \href{https://doi.org/10.5281/zenodo.22286846}{10.5281/zenodo.22286846}
(all versions)}}
...
eventually disappear? Lemma~\ref{lem:residues} leaves room for a yes: of
the twenty-eight even classes modulo $210$ lying over the four gap classes
modulo $30$, eight contain no sum of two members at all. A two-term sum is
$(p+\delta)+(p'+\delta')$ with $p,p'\equiv 2,3,4 \pmod 7$ by
Lemma~\ref{lem:residues}(ii), so $p+p'$ reaches only
$\equiv 4,5,6,0,1 \pmod 7$, and $\delta+\delta'$ is fixed by the class
modulo $30$; two classes modulo $7$ are missed in each case. The twenty
classes the lemma allows for gaps are exactly the twenty that survive.
\end{question}
