...
\date{Version 4, September 2026\\[2pt] {\small DOI: \href{https://doi.org/10.5281/zenodo.22286846}{10.5281/zenodo.22286846}
(all versions)}}
...
small expression in the royal members $2,3,5,7$; a congruence lemma modulo
$210$ shows that these ten are the only exceptions in the entire admissible
range below $10^9$, not merely the ones we met. Allowing one such
...
distinct members of earlier quadruplets. In one line:
\begin{center}
\emph{Every prime quadruplet after 2, 3, 5, 7 is a sum of the ones before it.}
\end{center}
The word ``sum'' is literal for $113{,}425$ of the $113{,}548$ quadruplet
members below $10^9$; the other $123$, namely $11$, $13$, $19$ and the
members whose gap is $82$, $84$, $88$ or $90$, need one product of royal
members, as in $101=19+17+13+11+(5\times7)+(2\times3)$.
...
Lemma~\ref{lem:residues} every gap lies in one of twenty classes modulo
$210$, and among all $38{,}092$ even numbers in those classes up to
$400{,}000$---a range that covers every gap below $10^9$, the largest being
$395{,}520$---exactly these ten are not sums of at most eight distinct
chain members below themselves. Ten further small values, $52$, $54$, $58$, $262$, $472$, $474$,
$478$, $772$, $774$ and $778$, are equally unreachable but can never occur
as gaps, their classes being excluded by the lemma. The last occurrence of
an exceptional gap below $10^9$ is at $\Q_{28063}$ (first member
$985{,}124{,}051$). In all, $254$ of the $113{,}544$ members meet an
exceptional gap, spread over $98$ quadruplets.
\end{conjecture}
...
with $\Rflat$ allowed there is no exception. In the light of
Lemma~\ref{lem:residues} the ten are exactly the coverage holes that
survive the congruence filter: of the twenty values below $400{,}000$ that
no sum of at most eight distinct members reaches, ten lie in classes no gap
can occupy. Within the admissible classes the pressure relaxes quickly:
below $400{,}000$ six terms suffice for every value above $1560$, and four
for every value above $53{,}370$. Appendix~\ref{app:exc} lists
...
Below $10^9$ only eight members do.
\begin{small}\begin{verbatim}
...
$90$), $52{,}872$ end with an added royal value, and $60{,}552$ are pure
...
all four members          & 26875 & 31 & 77280 & 2 & 8323 & 256 & 755 & 22 & 60552 / 52872 / 120 \\
\bottomrule
\end{tabular}
\end{table}
...
\midrule
real prime quadruplets & 8 & \textbf{10} & 254 & \textbf{382} \\
...
\bottomrule
\end{tabular}
\caption{All $28{,}387$ quadruplets of each chain below $10^9$, $113{,}544$
members, under the base rule of Section~\ref{sec:defs}. ``Exceptional
gaps'' counts distinct values of $D$ admitting no purely additive
representation.}
\label{tab:controls}
\end{table}

The exceptions are a different matter. The real chain has ten, the best
control has $101$ --- an order of magnitude more --- and every control
...
\emph{rare}. They do not predict that there should be only ten, that all
ten should be small, or that the set should close: no new exceptional gap
...
\end{verbatim}\end{small}
The dataset \code{qarray\_1e9.json} ($48{,}075{,}713$ bytes) has SHA-256
\begin{center}\footnotesize\code{75589aa7dd663b0f5eafd72c00c76ed15907882802495e9acbfcab6e76da42f4}\end{center}
...
minimal lengths. The control chains of Section~\ref{sec:density} are generated inside
