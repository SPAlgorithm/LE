...
\date{Version 2, September 2026\\[2pt] {\small DOI: \href{https://doi.org/10.5281/zenodo.22286846}{10.5281/zenodo.22286846}
(all versions)}}
...
closed set of exceptions. We also prove, from a two-line lemma and computed base cases, that the chain is an
...
beyond $\Q_{435}$ (first member $3{,}512{,}231$) up to $10^9$: the ten
values are complete there and recur without addition, the last occurrence
being at $\Q_{28063}$ (first member $985{,}124{,}051$). In all, $254$ of
the $113{,}544$ members meet an exceptional gap, spread over $98$
quadruplets.
\end{conjecture}
